> **Authority note:** This file is a **UI/UX Pro Max recommendation**, not the shipped system.
> Incumbent visual truth lives in root `DESIGN.md` + `.impeccable/design.json`.
> Use this MASTER only when explicitly redesigning toward the Pro Max direction.
